...
#######################################################################
# 1st GTx Solution:
# Let's start with the function definition. We know:
# - The function should be called snowed_in.
# - It should have three parameters: temperature, weather,
#   and is_celsius.
# - is_celsius should assume the value 'True'.
#
# 'Assume the value' means that is_celsius should be a
# keyword parameter: that means that it has some default
# value, but the function call *could* override that default
# value.
#
# So, here's our function declaration. Note that the = True
# after is_celsius makes is_celsius a keyword parameter.
...
def snowed_in(temperature, weather, is_celsius=True):
    ...
    # With that function defined, we can call snowed_in either
    # defining a value for is_celsius or not:
