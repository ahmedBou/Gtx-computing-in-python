...
def is_a_contender(team_name, wins, loss):
    if wins>= 40 and loss <= 20:
        a = "The {} are a contender!".format(team_name)
        return a
    elif wins <= 40 and loss >= 20:
        b = "The {} are not a contender!".format(team_name)
        return b
    else:
        c = "The {} might be a contender!".format(team_name)
        return c
